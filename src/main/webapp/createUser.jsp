...
<div>
        ...
        <div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="date" name="userBirthDate" onkeydown="return false" value="${userBirthDate}"></td>
                    <td>
        ...
        <div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="date" name="passportDateOfIssue" onkeydown="return false" value="${passportDateOfIssue}"></td>
                    <td>
    ...
    <form name="createUser" method="post" action="users">
        <input type="hidden" name="command" value="cancelCreareUser">
