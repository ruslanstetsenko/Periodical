            ...
            <div>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea class="input_passpIssuedBy" type="text" name="passportIssuedBy">${passportIssuedBy}</textarea>
                            <span class="error">
            ...
            <div>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input class="autorization_info" type="text" name="login" value="${login}" disabled></td>
                        <%--<td>--%>
                    ...
                    <tr>
                        ...
                        <td><input class="autorization_info" type="text" name="password" value="${password}" disabled></td>
                        <%--<td>--%>
